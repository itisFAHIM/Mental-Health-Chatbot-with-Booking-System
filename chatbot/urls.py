...
# chatbot/urls.py (Cleaned Version)
from django.urls import path
from . import views
...
urlpatterns = [
    ...
    # RAG CHAT API
    path('api/article-rag/', views.article_rag_api, name='article_rag_api'),

    # Medicine Management
    path('medicines/', views.manage_medicines_view, name='manage_medicines'),

    # Prescription Management
    path('prescription/create/<int:patient_id>/', views.create_prescription_view, name='create_prescription'),
    path('prescription/view/<uuid:prescription_id>/', views.view_prescription_view, name='view_prescription'),
    path('prescription/download/<uuid:prescription_id>/', views.download_prescription_pdf, name='download_prescription'),

    path('prescription/edit-patient/<uuid:prescription_id>/', views.edit_prescription_patient_view, name='edit_prescription_patient'),  # NEW

    # Notifications
    path('notifications/', views.notifications_view, name='notifications'),  # NEW
    path('notifications/read/<int:notification_id>/', views.mark_notification_read, name='mark_notification_read'),  # NEW
